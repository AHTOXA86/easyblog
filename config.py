...
SETTINGS = {
    ...
    'disqus': 'False',
    # DON'T CHANGE IT. This gets the the current yeat to be display on your page,
    # so you won't need to keep updating it. 
    'year': datetime.datetime.now().year,
    # The easyblog repo url used for the "powered by" label
    'easyblog_url':'https://github.com/AHTOXA86/easyblog'
}
